    ...
    return (
        <div className="py-5 ">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 items-center">
                <div className="w-[445px] h-[208px] ">
                    <h1 className=" font-(family-name:--main-font) text-white text-[40px] md:text-7xl lg:text-[88px] font-bold">Contact</h1>
                    <p className="font-(family-name:--main-font) text-[18px] text-[var(--grayColor)]">I would love to hear about your project and how I could help. Please fill in the form, and I’ll get back to you as soon as possible.</p>
                </div>
